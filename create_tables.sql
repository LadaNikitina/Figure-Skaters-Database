...
DROP TABLE IF EXISTS figure_skating.federation CASCADE;
...
DROP TABLE IF EXISTS figure_skating.figure_skater CASCADE;
...
-- create table judge
DROP TABLE IF EXISTS figure_skating.judge CASCADE;
...
DROP TABLE IF EXISTS figure_skating.competition CASCADE;
...
DROP TABLE IF EXISTS figure_skating.element CASCADE;
...
DROP TABLE IF EXISTS figure_skating.performance CASCADE;
...
DROP TABLE IF EXISTS figure_skating.judge_X_competition CASCADE;
...
DROP TABLE IF EXISTS figure_skating.performance_X_element CASCADE;
